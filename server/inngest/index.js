...
const sendNotificationOfUnseenMessages = inngest.createFunction(
  ...
  async ({step}) => {
    ...
    for (const userId in unseenCount) {
      ...
      const body = '<div style="font-family:Arial, sans-serif; padding:20 px;"><h2> Hi ${user.full_name},</h2><p>You have ${unseenCount[userId]} unseen messages. Click <a href="${process.env.FRONTEND_URL}/messages" style="color":#10b981;">here</a> to check your messages.</p><br/><p>Thanks,<br/>PingUp - Stay Connected</p></div>';
