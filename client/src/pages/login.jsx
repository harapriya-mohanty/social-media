      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              <div className='flex'>
                {Array(4).fill(0).map((_,i)=>(<Star key={i} className='size-4 md:size-4.5 text-transparent fill-amber-500'/>))}
              </div>
              <p>Used by 12k+ developers </p>
            </div>
          </div>
          <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-800 bg-clip-text text-transparent'>More than just friends truly connect</h1>
